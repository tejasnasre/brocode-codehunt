          ...
          {user ? (
            <>
              ...
              >
                <Button
                  variant="outline"
                  className="font-semibold border-2 border-black hover:bg-primary hover:text-white transition-colors"
                >
                  Profile
                </Button>
              </Link>
            ...
            <>
              ...
              <Link href="/auth/signup">
                <Button className="font-semibold border-2 border-black bg-primary text-white hover:bg-primary-dark transition-colors">
                  Sign Up
                </Button>
              </Link>
            </>
